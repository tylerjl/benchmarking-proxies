...
set origin 0,0
set size 0.7,1
plot for [col=2:7] data using col:xtic(1)
unset xlabel
unset key
unset title
set ytics
...
set origin 0.7,0
set size 0.3,0.5
plot for [col=2:7] requests using col:xtic(1) axes x1y1 notitle
set ylabel "%" tc rgb "white"
set ytics
set yrange [0:100]
set origin 0.7,0.5
set size 0.3,0.5
plot for [col=2:7] errors using col:xtic(1) axes x1y1 notitle